...
class Tickets extends AdminController
{
    ...
    public function add($userid = false)
    {
        if ($this->input->post()) {
            ...
            if ($data['subscribed_service']) {
                $data['subscribed_service'] = implode(',', $data['subscribed_service']);
            }
    ...
    {
        $data = $_GET['id_contact'];
        if ($res = check_contact_data($data)) {
            $subscribed = explode(',', $res['subscribed_service']);
            $field = '';
            $field .= '<div class="row">';
            $field .= '<div class="col-md-4">';
            $field .= '<div class="form-group" app-field-wrapper="account_number"><label for="account_number" class="control-label">Account Number</label><input type="text" id="account_number" name="account_number" class="form-control" readonly value="' . $res['account_number'] . '"></div>';
            $field .= '</div>';
            $field .= '<div class="col-md-4">';
            $field .= '<div class="form-group" app-field-wrapper="system"><label for="system" class="control-label">System</label><input type="text" id="system" name="system" class="form-control" readonly value="' . $res['system_name'] . '"></div>';
            $field .= '</div>';
            $field .= '<div class="col-md-4">';
            $field .= '<div class="form-group" app-field-wrapper="contact_number"><label for="contact_number" class="control-label">Contact Number</label><input type="text" id="phonenumber" name="phonenumber" class="form-control" readonly value="' . $res['phonenumber'] . '" ></div>';
            $field .= '</div>';
            $field .= '<div class="col-md-4">';
            $field .= '<div class="form-group" app-field-wrapper="service_address"><label for="service_address" class="control-label">Service Address</label><textarea id="service_address" name="service_address" class="form-control" readonly rows="4">' . $res['address'] . '</textarea></div>';
            $field .= '</div>';
            $field .= '<div class="col-md-4">';
            $field .= '<div class="form-group" app-field-wrapper="subscribed_services"><label for="subscribed_services" class="control-label">Subscribed Services</label><br><input class="custom_field_checkbox mr-2" data-fieldto="customers" data-fieldid="23" value="High Speed Internet" type="checkbox"';
            if (in_array("High Speed Internet", $subscribed)) {
                $field .= ' checked ';
            }
            $field .= 'name="subscribed_service[]" readonly /> <label class="cf-chk-label">High Speed Internet</label><br>
            <input class="custom_field_checkbox mr-2" data-fieldto="customers" data-fieldid="23" value="Home Phone" type="checkbox"';
            if (in_array("Home Phone", $subscribed)) {
                $field .= ' checked ';
            }
            $field .= 'name="subscribed_service[]" readonly /> <label class="cf-chk-label">Home Phone</label><br>
            <input class="custom_field_checkbox mr-2" data-fieldto="customers" data-fieldid="23" value="Cable TV" type="checkbox"';
            if (in_array("Cable TV", $subscribed)) {
                $field .= ' checked ';
            }
            $field .= 'name="subscribed_service[]" readonly /> <label class="cf-chk-label">Cable TV</label><br></div>';
            $field .= '</div>';
            $field .= '</div>';
            echo $field;
        }
