            ...
            <div class="f_client_id">
              <div class="form-group select-placeholder">
               ...
               <?php $selected = (isset($invoice) ? $invoice->clientid : '');
                ...
                <!-- <select id="clientid" name="clientid" data-live-search="true" data-width="100%" class="ajax-search" data-none-selected-text="Nothing selected" tabindex="-98"><option class="bs-title-option" value=""></option><optgroup label="Currently Selected">
                  <option value="" title="" ></option>
                  <option value="35" title="">Customer 5</option>
               </optgroup></select> -->
              </div>
            </div>
            <?php
