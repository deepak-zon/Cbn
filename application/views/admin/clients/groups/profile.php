         ...
         <?php if ($customer_custom_fields) { ?>
            <div role="tabpanel" class="tab-pane <?php if ($this->input->get('tab') == 'custom_fields') {
               ...
               <div class="row custom-fields-form-row">
                  <div class="col-md-3">
                     <div class="form-group" app-field-wrapper="custom_fields[customers][1]"><label for="custom_fields[customers][1]" class="control-label"><small class="req text-danger">* </small>Account Number</label><input type="text" id="custom_account" name="account_number" class="form-control" data-fieldto="customers" data-fieldid="1" value="<?= customfield_value_get($this->uri->uri_string(), 'account_number'); ?>" <?php if (customfield_value_get($this->uri->uri_string(), 'account_number')) {
                                                                                                                                                                                                                                                                                                                                                                                                                                             echo "readonly";
                                                                                                                                                                                                                                                                                                                                                                                                                                          } ?>></div>
                  </div>
                  <?php $result = customfield_value_get($this->uri->uri_string(), 'franchise'); ?>
                  <div class="col-md-3">
                     <div class="form-group" app-field-wrapper="custom_fields[customers][2]"><label for="custom_fields[customers][2]" class="control-label"><small class="req text-danger">* </small>Franchise</label>
                        <div class="dropdown bootstrap-select form-control bs3" style="width: 100%;"><select id="frenchise_id" onchange="set_frenchise();" data-url="<?= base_url('admin/clients/fencthise_data_set'); ?>" data-actionurl="<?= $this->uri->uri_string(); ?>" name="franchise" class="selectpicker form-control" data-width="100%" data-none-selected-text="Nothing selected" data-live-search="true" tabindex="-98" required <?php if ($result) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                echo "disabled";
                                                                                                                                                                                                                                                                                                                                                                                                                                             } ?>>
                              <option value=""></option>
                              <?php
                              foreach (data_franchise() as $res) { ?>
                                 <option <?php if ($result == $res['id']) {
                                             echo "selected";
                                          } ?> value="<?= $res['id']; ?>"><?= $res['franchise_name']; ?></option>
                              <?php } ?>
                           </select>
                        </div>
                     </div>
                  ...
                  <div class="col-md-3">
                     <div class="form-group" app-field-wrapper="custom_fields[customers][3]"><label for="custom_fields[customers][3]" class="control-label"><small class="req text-danger">* </small>System</label>
                        <div class="dropdown bootstrap-select form-control bs3" style="width: 100%;"><select id="system_id" onchange="set_system();" data-url="<?= base_url('admin/clients/system_data_set'); ?>" data-actionurl="<?= $this->uri->uri_string(); ?>" data-fieldto="customers" data-fieldid="3" name="system" class="selectpicker form-control" data-width="100%" data-none-selected-text="Nothing selected" data-live-search="true" tabindex="-98" required <?php if ($result) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                              echo "disabled";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                           } ?>>
                              <?php
                              $result_system = system_value_get($this->uri->uri_string());
                              if ($result_system) { ?><option value="<?= $result_system['id']; ?>"><?= $result_system['system_name']; ?></option><?php } ?>
                           </select>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-3">
                     <div class="form-group"><label class="control-label"><small class="req text-danger">* </small>SSN</label>
                        <div class="input-group">
                           <input type="text" class="form-control" id="ssn_value" data-ssnvalue="ssn_true" onkeyup="ssn_value_change()" autocomplete="off" value="<?= str_pad(substr($client->ssn, -4), strlen($client->ssn), '*', STR_PAD_LEFT);  ?>" required <?php if (isset($client->ssn)) {
                                                                                                                                                                                                                                                                     echo "readonly";
                                                                                                                                                                                                                                                                  } ?>>
                           <input type="hidden" name="ssn" id="ssn" value="<?= $client->ssn; ?>">
                           <input type="hidden" id="ssn_changes" value="2">
                           <span class="input-group-addon">
                              <a href="#" onclick="showssn(); return false;"><i class="fa fa-eye"></i></a>
                           </span>
                        </div>
                     </div>
                  </div>
               ...
               <?php $subscribed = explode(',', customfield_value_get($this->uri->uri_string(), 'subscribed_service')); ?>
               <div class="row custom-fields-form-row">
                  <div class="col-md-6">
                     <div class="form-group chk"><br><label class="control-label no-mbot" for="custom_fields[customers][4][]"><small class="req text-danger"> </small>Subscribed Service </label></div>
                     <input class="custom_field_checkbox mr-2" data-fieldto="customers" data-fieldid="23" value="High Speed Internet" type="checkbox" <?php if (in_array("High Speed Internet", $subscribed)) {
                                                                                                                                                         echo "checked";
                                                                                                                                                      } ?> name="subscribed_service[]"> <label class="cf-chk-label">High Speed Internet</label>&nbsp;&nbsp;
                     <input class="custom_field_checkbox mr-2" data-fieldto="customers" data-fieldid="23" value="Home Phone" type="checkbox" <?php if (in_array("Home Phone", $subscribed)) {
                                                                                                                                                echo "checked";
                                                                                                                                             } ?> name="subscribed_service[]"> <label class="cf-chk-label">Home Phone</label>&nbsp;&nbsp;
                     <input class="custom_field_checkbox mr-2" <?php if (in_array("Cable TV", $subscribed)) {
                                                                  echo "checked";
                                                               } ?> data-fieldto="customers" data-fieldid="23" value="Cable TV" type="checkbox" name="subscribed_service[]"> <label class="cf-chk-label">Cable TV</label>&nbsp;&nbsp;
                  </div>
               </div>
            </div>
            <script>
               function set_frenchise() {
                  var url_franchise = $('#frenchise_id').data("url");
                  var data_franchise = $('#frenchise_id').val();
                  var data_actionurl = $('#frenchise_id').data("actionurl");
                  $.ajax({
                     type: "GET",
                     url: url_franchise,
                     dataType: "json",
                     data: {
                        franchise_id: data_franchise,
                        actionurl: data_actionurl
                     },
                     success: function(result) {
                        $('#custom_account').val(result.account);
                        $('#system_id').html(result.system_option);
               ...
               function set_system() {
                  var url_system = $('#system_id').data("url");
                  var data_system = $('#system_id').val();
                  var data_actionurl = $('#system_id').data("actionurl");
                  $.ajax({
                     type: "GET",
                     url: url_system,
                     data: {
                        franchise_id: data_system,
                        actionurl: data_actionurl
                     },
                     success: function(result) {}
                  });
               ...
               function showssn() {
                  var target = $('#ssn_changes').val();
                  if (target == '2') {
                     $('#ssn_value').attr("readonly", false);
                     var ssndata = $('#ssn').val();
                     $('#ssn_value').val(ssndata);
                     $("#ssn_value").prop("type", "number");
                     $('#ssn_changes').val("1");
                  } else {
                     $('#ssn_changes').val("2");
                     var value = $('#ssn_value').val();
                     var data = value.replace(/\d(?=\d{4})/g, "*");
                     $("#ssn_value").prop("type", "text");
                     $('#ssn_value').val(data);
                     $('#ssn_value').attr("readonly", true);
                  }
               }

               function ssn_value_change() {
                  var data = $('#ssn_value').val();
                  $('#ssn').val(data);
               }
            </script>
         <?php } ?>
