                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="select-placeholder form-group">
                            ...
                            <select name="type" id="type" class="selectpicker" <?php if (isset($custom_field) && total_rows(db_prefix() . 'customfieldsvalues', array('fieldid' => $custom_field->id, 'fieldto' => $custom_field->fieldto)) > 0) {
                                                                                    echo ' disabled';
                                                                                } ?> data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-hide-disabled="true">
                                <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" max="12" class="form-control" name="bs_column" id="bs_column" value="<?php if (!isset($custom_field)) {
                                                                                                                                echo 12;
                                                                                                                            } else {
