						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group select-placeholder" id="ticket_contact_w">
									...
									<select name="contactid" required="true" id="contactid" data-url="<?= base_url('admin/tickets/show_contact_data'); ?>" class="ajax-search" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
