         ...
         <div class="panel_s">
            <div class="panel-body">
               ...
               <div role="tabpanel" class="tab-pane <?php if($this->session->flashdata('active_tab_settings')){echo 'active';} ?>" id="settings">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group select-placeholder">
                           ...
                           <select name="contactid" id="contactid" data-url="<?= base_url('admin/tickets/show_contact_data'); ?>" class="ajax-search" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"<?php if(!$ticket->userid){echo ' data-no-contact="true"';} else {echo ' data-ticket-emails="'.$ticket->ticket_emails.'"';} ?>>
                              <?php
                  ...
                  <div class="col-md-12" id="contact_fields">
...
<script>
   $(document).ready(function(){
      ...
      var contact_url = $("#contactid").data('url');
      if(contact_id){
         fetch_contact_data(contact_id, contact_url)
      }else{
         $('#contact_fields').html("");
      }
   });
   ...
   function fetch_contact_data(id, url){
      var contact_id = id;
      var contact_url = url;
      $.ajax({
         type: "GET",
