                        ...
                        <div class="panel_s">
                           <div class="panel-body">
                              <div class="row">
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                          ...
                                          $related = array(
                                             ...
                                             ['value' => 'service', "rel_type" => _l('rm_custom_service')],
                                          );
                                          if ($reminderData->is_complete == '0') {
                                 ...
                                 <div class="col-md-12 recurring_custom_service <?php if ((isset($reminderData) && $reminderData->rel_type != "service") || (!isset($reminderData))) {
                                                                                    echo 'hide';
                                                                                 } ?>">
                                    <div class="row">
                                       <div class="col-md-6">
                                          <?php echo render_select_with_input_group('services[]', $services, array('id', 'service_name'), 'reminder_service_type', $servicesData, '<a href="#" data-toggle="modal" data-target="#reminder_add_service"><i class="fa fa-plus"></i></a>', array('multiple' => true, 'data-actions-box' => true), array(), '', 'reminder_service', false);
                                          ?>
                                       </div>
                                       <div class="col-md-6">
                                          ...
                                          <div class="input-group" data-toggle="tooltip" title="<?php echo _l('reminder_amount'); ?>">
                                             <input type="number" class="form-control" id="amountreminder" name="total_amount" value="<?= $reminderData->total_amount; ?>">
