                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                                    ...
                                                    <div class="form-group select-placeholder">
                                                        ...
                                                        <div class="flexer">
                                                            <select name="customer" id="customer" class="selectpicker" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                                <option value="" <?php if ((isset($proposal) &&  $proposal->rel_type == 'customer') || $this->input->get('rel_type') || !empty($rel_type)) {
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group select-placeholder">
                                                    ...
                                                    <select name="rel_type" id="rel_type" class="selectpicker" data-width="100%">
                                                        <option value=""></option>
                                                        <option value="proposal"><?php echo _l('rm_proposals'); ?></option>
                                                        ...
                                                        <option value="ticket"><?php echo _l('rm_tickets'); ?></option>
                                                        <option value="custom_reminder"><?php echo _l('rm_custom_reminder'); ?></option>
                                                        <option value="service"><?php echo _l('rm_custom_service'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 recurring_custom_service hide">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <?php echo render_select_with_input_group('services[]', $services, array('id', 'service_name'), 'reminder_service_type', '', '<a href="#" data-toggle="modal" data-target="#reminder_add_service"><i class="fa fa-plus"></i></a>', array('multiple' => true, 'data-actions-box' => true), array(), '', 'service_reminder', false);
                                                        ?>
                                                    </div>
                                                    <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <?php
                                                $related = array(
                                                    ['value' => '1-week', "option" => _l('week')],
                                                    ['value' => '2-week', "option" => '2 ' . _l('weeks')],
                                                    ['value' => '1-month', "option" => '1 ' .  _l('month')],
                                                    ['value' => '2-month', "option" => '2 ' .  _l('months')],
                                                    ['value' => '3-month', "option" => '3 ' .  _l('months')],
                                                    ['value' => '6-month', "option" => '6 ' .  _l('months')],
                                                    ['value' => '1-year', "option" => '1 ' .  _l('year')],
                                                    ['value' => 'custom', "option" => _l('recurring_custom')],
                                                );
                                                echo render_select('repeat_every', $related, array('value', 'option'), 'task_repeat_every', '');
                                                ?>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <select name="repeat_type_custom" id="repeat_type_custom" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                            <option value="day"><?php echo _l('task_recurring_days'); ?></option>
                                                            <option value="week"><?php echo _l('task_recurring_weeks'); ?></option>
                                                            <option value="month"><?php echo _l('task_recurring_months'); ?></option>
                                                            <option value="year"><?php echo _l('task_recurring_years'); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
