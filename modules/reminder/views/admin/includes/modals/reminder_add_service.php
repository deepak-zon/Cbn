...
<div class="modal fade" id="reminder_add_service" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url() . 'reminder/reminder_new_service/', array('id' => 'reminder-form', 'class' => '_transaction_form_reminder reminder-form new_items_table form_submit', 'id' => 'reminder-form')); ?>
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="submit_button" class="btn btn-info"><?php echo _l('submit'); ?></button>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
